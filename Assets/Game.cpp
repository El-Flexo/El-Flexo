...
//	switch (side)
//	{
//	case TOP: exitY = 0; exitX = width + (50 /*rand()*/ % (800 / width)) * width;
//		posX = exitX;
//		do {
//			if (posX == 0 && posY > 0)
//			{
...
bool Game::isCollision(Model &model1, Model &model2) const
{
	if (model1.X + model1.width > model2.X &&
		...
		model1.Y + model1.width > model2.Y &&
		model1.Y < model2.Y + model2.width)
	{
		return true;
	}
	else
